...
public interface PersonControllerDocs {
    ...
    @Operation(summary = "Export People",
            description = "Exporting a Page of People in XLSX and CSV format",
            tags = {"People"},
            responses = {
                    @ApiResponse(description = "Success", responseCode = "200", content = {
    ...
    @Operation(summary = "Export a person",
            description = "Exporting a person by your Id in PDF format",
            tags = {"People"},
            responses = {
                    @ApiResponse(description = "Success", responseCode = "200", content = {
    ...
    ResponseEntity<PersonDTO> insert(@RequestBody PersonDTO person);

    @Operation(summary = "Editing a person",
            description = "Editing a specific person by your Id",
            tags = {"People"},
            responses = {
                    @ApiResponse(
                            description = "Success",
    ...
    ResponseEntity<PersonDTO> update(@PathVariable Long id, @RequestBody PersonDTO person);
    ...
    ResponseEntity<PersonDTO> disablePerson(@PathVariable Long id);

    @Operation(summary = "Delete a person",
            description = "Delete a specific person by your Id",
            tags = {"People"},
            responses = {
                    @ApiResponse(description = "No Content", responseCode = "204", content = @Content(schema = @Schema(implementation = PersonDTO.class))),
                    @ApiResponse(description = "Bad Request", responseCode = "400", content = @Content),
                    @ApiResponse(description = "Unauthorized", responseCode = "401", content = @Content),
                    @ApiResponse(description = "Not Found", responseCode = "404", content = @Content),
                    @ApiResponse(description = "Internal Server Error", responseCode = "500", content = @Content),
